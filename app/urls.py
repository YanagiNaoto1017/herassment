...
urlpatterns = [
    ...
    path('report_complete', views.ReportCompleteView.as_view(), name='report_complete'), # 完了画面
    path('delete_complete', views.DeleteCompleteView.as_view(), name='delete_complete'), # 完了画面
